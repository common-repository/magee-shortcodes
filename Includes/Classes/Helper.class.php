	...
	*/
	...
	public function shortcode_form() {
		...
		if ( $shortcode && isset($magee_shortcodes[$shortcode]) ) {
			...
			echo "<script src='".MAGEE_SHORTCODES_URL."assets/datetimepicker/jquery.datetimepicker.full.js'></script>/";
			echo "<link rel='stylesheet' href='".MAGEE_SHORTCODES_URL."assets/datetimepicker/jquery.datetimepicker.css'/>";
		}
